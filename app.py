...
MONGODB_URI = "mongodb://admin:flask1234@ds131061.mlab.com:31061/student_record"
...
def get_student(roll_no):
    ...
    if not student:
        return jsonify({"error": "Student is not registered."}), 404  # Syntax: return data, status_code
